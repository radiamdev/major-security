...
const Footer = () => {
    return (
        <Container tag="footer" className="bg-blue-primary relative">
            ...
            <div className="bg-gray-primary flex lg:flex-row flex-col items-center justify-between lg:w-[55%] w-[90%] lg:py-6 py-2 lg:px-12 px-6 lg:gap-8 gap-1 absolute -top-12 left-1/2 transform -translate-x-1/2">
